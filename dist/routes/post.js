...
const file_sistem_1 = __importDefault(require("../classes/file-sistem"));
const postRoutes = (0, express_1.Router)();
const fileSystem = new file_sistem_1.default();
//crear post
postRoutes.post('/', [autenticacion_1.verificaToken], (req, res) => {
    const body = req.body;
    body.usuario = req.usuario._id;
    const imagenes = fileSystem.imagenesDeTempHaciaPost(req.usuario_id);
    body.imgs = imagenes;
...
//servicio para subir archivos solo imagenes
